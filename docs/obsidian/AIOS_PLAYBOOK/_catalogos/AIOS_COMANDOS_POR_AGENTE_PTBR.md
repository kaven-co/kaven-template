---
title: AIOS_COMANDOS_POR_AGENTE_PTBR
version: 1.0.0
type: catalog
domain: aios
...
# AIOS - Comandos por Agente (PT-BR)

Fonte: \.aios-core/development/agents
Gerado em: 2026-02-12 23:31:40 -03

## Índice
- [Orion (`aios-master`)](#orion-aios-master)
- [Atlas (`analyst`)](#atlas-analyst)
- [Aria (`architect`)](#aria-architect)
- [Dara (`data-engineer`)](#dara-data-engineer)
- [Dex (`dev`)](#dex-dev)
- [Gage (`devops`)](#gage-devops)
- [Morgan (`pm`)](#morgan-pm)
- [Pax (`po`)](#pax-po)
- [Quinn (`qa`)](#quinn-qa)
- [River (`sm`)](#river-sm)
- [Craft (`squad-creator`)](#craft-squad-creator)
- [Uma (`ux-design-expert`)](#uma-ux-design-expert)
