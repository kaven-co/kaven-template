    ...
    <DropdownMenu open={open} onOpenChange={setOpen}>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          {state.unreadCount > 0 && (
            <div className="absolute -top-1 -right-1 z-10 min-w-5 h-5 bg-red-500 rounded-full flex items-center justify-center px-1 text-xs font-bold text-white">
        ...
        <div className="p-4 border-b">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Button variant="ghost" size="sm" className="text-xs" aria-label="Notification settings">
